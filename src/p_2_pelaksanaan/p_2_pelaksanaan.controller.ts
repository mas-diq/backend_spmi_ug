...
@Controller("p_2")
export class P2PelaksanaanController {

  constructor(
    private readonly localService: P2PelaksanaanService
  ) {
  }
  ...
  @Post("/createData")
  async createData(
    @Body() createDataDto: Create_p_2_pelaksanaanDto
  ) {
  ...
  async editDataForEditor(
    @Body("id") id: string,
    @Body() updateDataDto: Update_p_2_pelaksanaanDto
  ) {
